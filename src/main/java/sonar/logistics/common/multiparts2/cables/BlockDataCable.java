...
public class BlockDataCable extends BlockLogisticsMultipart {
	...
	public void neighborChanged(IBlockState state, World world, BlockPos pos, Block blockIn, BlockPos fromPos) {
		...
		if (cable != null && !world.isRemote) {
			CableConnectionHandler.onNeighbourBlockStateChanged(cable, pos, fromPos);
		}
	}
	...
	public void onNeighborChange(IBlockAccess world, BlockPos pos, BlockPos neighbor) {
		...
		if (cable != null && !cable.getWorld().isRemote) {
			CableConnectionHandler.onNeighbourTileEntityChanged(cable, pos, neighbor);
		}
	}
	...
	public void onPartAdded(IPartInfo part, IPartInfo otherPart) {
		...
		if (!part.getActualWorld().isRemote && part.getTile()!=null && part.getTile() instanceof IDataCable) {
			CableConnectionHandler.onNeighbourMultipartAdded(((IDataCable) part.getTile()), part, otherPart);
		}
	}
	...
	public void onPartRemoved(IPartInfo part, IPartInfo otherPart) {
		...
		if (!part.getActualWorld().isRemote && part.getTile()!=null && part.getTile() instanceof IDataCable) {
			CableConnectionHandler.onNeighbourMultipartRemoved(((IDataCable) part.getTile()), part, otherPart);
		}
	}
