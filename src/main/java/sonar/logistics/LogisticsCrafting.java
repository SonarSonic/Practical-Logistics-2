...
public class LogisticsCrafting extends Logistics {
	...
	public static void addRecipes() {
		...
		addShapedOre(new ItemStack(LogisticsItems.partTransferNode, 1), new Object[] { "   ", " C ", "PDP", 'P', LogisticsItems.stone_plate, 'D', LogisticsItems.etched_plate, 'C', LogisticsItems.partNode });
		addShapedOre(new ItemStack(LogisticsBlocks.hammer, 1), new Object[] { "ADA", "B B", "ACA", 'A', "logWood", 'B', "stickWood", 'C', "stone", 'D', "slabWood" });
		addShapelessOre(new ItemStack(LogisticsItems.partEntityNode, 1), new Object[] { LogisticsItems.stone_plate, "gemSapphire", LogisticsItems.partCable });
		...
		addShapedOre(new ItemStack(LogisticsItems.wirelessStorage, 1), new Object[] { "ABC", "DEF", "GBH", 'A', LogisticsItems.inventoryReaderPart, 'B', LogisticsItems.stone_plate, 'C', LogisticsItems.fluidReaderPart, 'D', LogisticsItems.transceiver, 'E', LogisticsItems.etched_plate, 'F', LogisticsItems.entityTransceiver, 'G', LogisticsItems.infoReaderPart, 'H', LogisticsItems.energyReaderPart });
		addShapedOre(new ItemStack(LogisticsItems.entityTransceiver, 1), new Object[] { "SPD", "RBE", "SPD", 'P', LogisticsItems.stone_plate, 'B', Items.ENDER_EYE, 'S', "dustSapphire", 'D', "dustRedstone", 'E', LogisticsItems.partEmitter, 'R', LogisticsItems.partReceiver });
