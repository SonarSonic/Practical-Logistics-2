...
public class LogisticsCrafting extends Logistics {
	...
	public static void addRecipes() {
		...
		//addShapedOre(new ItemStack(LogisticsBlocks.holographicDisplay, 1), new Object[] { "   ", "PDP", " C ", 'P', LogisticsItems.stone_plate, 'D', LogisticsItems.displayScreen, 'C', LogisticsItems.partCable });
