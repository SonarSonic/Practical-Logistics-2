...
public abstract class AbstractWirelessManager<E extends IWirelessEmitter, R extends IWirelessReceiver> implements IWirelessManager<E, R> {
	...
	public abstract void onReceiverConnected(ILogisticsNetwork main, R receiver);	

	public abstract void onReceiverDisconnected(ILogisticsNetwork network, R receiver);
	...
	public void connectReceiver(ILogisticsNetwork network, R receiver) {
	...
	public void disconnectReceiver(ILogisticsNetwork network, R receiver) {
	...
	public void connectEmitter(ILogisticsNetwork network, E emitter) {
	...
	public void disconnectEmitter(ILogisticsNetwork network, E emitter) {
	 ...
	 * @param emitter the {@link IDataEmitter} which has been connected */
	public void onEmitterConnected(ILogisticsNetwork network, E emitter) {
	 ...
	 * @param main the {@link IDataEmitter}'s network
	 * @param emitter the {@link IDataEmitter} which has been disconnected */
	public void onEmitterDisconnected(ILogisticsNetwork network, E emitter) {
		receivers.forEach(receiver -> {
			if (receiver.canAccess(emitter).isConnected()) {
