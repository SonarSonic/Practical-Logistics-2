...
public class LogisticsCommon implements IGuiHandler {
	...
	public static void registerPackets() {
		...
		Logistics.network.registerMessage(PacketChannels.Handler.class, PacketChannels.class, 1, Side.CLIENT);
		...
		Logistics.network.registerMessage(PacketViewables.Handler.class, PacketViewables.class, 6, Side.CLIENT);
		...
		Logistics.network.registerMessage(PacketWirelessStorage.Handler.class, PacketWirelessStorage.class, 12, Side.SERVER);
