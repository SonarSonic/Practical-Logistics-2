...
public class LogisticsColours {
	...
	public static final ResourceLocation colourTex1 = new ResourceLocation(Logistics.MODID + ":textures/model/" + "progress1.png");
	public static final ResourceLocation colourTex2 = new ResourceLocation(Logistics.MODID + ":textures/model/" + "progress2.png");
	public static final ResourceLocation colourTex3 = new ResourceLocation(Logistics.MODID + ":textures/model/" + "progress3.png");
	public static final ResourceLocation colourTex4 = new ResourceLocation(Logistics.MODID + ":textures/model/" + "progress4.png");
