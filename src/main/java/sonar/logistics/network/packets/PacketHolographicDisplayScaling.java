...
public class PacketHolographicDisplayScaling extends PacketMultipart {
    ...
    public void fromBytes(ByteBuf buf) {
        ...
        screenScale = DisplayVectorHelper.readVec3d("scale", nbt, NBTHelper.SyncType.SAVE);
        screenRotation = DisplayVectorHelper.readVec3d("rotate", nbt, NBTHelper.SyncType.SAVE);
        screenOffset = DisplayVectorHelper.readVec3d("offset", nbt, NBTHelper.SyncType.SAVE);
        colour = buf.readInt();
    }
    ...
    public void toBytes(ByteBuf buf) {
        ...
        DisplayVectorHelper.writeVec3d(screenScale,"scale", nbt, NBTHelper.SyncType.SAVE);
        DisplayVectorHelper.writeVec3d(screenRotation,"rotate", nbt, NBTHelper.SyncType.SAVE);
        DisplayVectorHelper.writeVec3d(screenOffset,"offset", nbt, NBTHelper.SyncType.SAVE);
