...
public class EditContainer extends DisplayElementContainer {
	...
	public static EditContainer addEditContainer(DisplayGSI gsi) {
		...
		editList.getElements().addElement(new CreateElementButton(CreateInfoType.INFO, 0, 2, 15, "CREATE INFO"));
		editList.getElements().addElement(new CreateElementButton(CreateInfoType.TEXT, 1, 3, 3, "CREATE TEXT"));
