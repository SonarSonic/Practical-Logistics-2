...
public interface IRedstoneCable extends ICableRenderer, ICable {
	 ...
	 * <p>
	 * A "Local Provider" is a {@link IInfoProvider} which isn't directly connected to the handling but one side is still providing info to the handling these local providers are typically {@link IListReader}s. This is how the {@link IDisplay}s find connectable readers.
