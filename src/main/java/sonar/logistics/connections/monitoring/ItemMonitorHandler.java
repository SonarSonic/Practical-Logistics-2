...
@EntityMonitorHandler(handlerID = ItemMonitorHandler.id, modid = PL2Constants.MODID)
@TileMonitorHandler(handlerID = ItemMonitorHandler.id, modid = PL2Constants.MODID)
