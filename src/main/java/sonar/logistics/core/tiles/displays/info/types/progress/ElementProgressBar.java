...
@ASMDisplayElement(id = ElementProgressBar.REGISTRY_NAME, modid = PL2Constants.MODID)
public class ElementProgressBar extends AbstractInfoElement<InfoProgressBar> {
	...
	public void render(InfoProgressBar info) {
		...
		// DisplayElementHelper.drawRect(border_thickness, border_thickness, getActualScaling()[0] - border_thickness, getActualScaling()[1] - border_thickness, PL2Colours.grey_base.getRGB());
		GlStateManager.translate(0, 0, -0.001);
