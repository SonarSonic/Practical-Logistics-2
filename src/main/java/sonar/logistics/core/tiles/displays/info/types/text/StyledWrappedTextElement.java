...
import sonar.logistics.core.tiles.displays.info.types.text.utils.StyledStringRenderer.StyledStringRenderHandler;
...
@ASMDisplayElement(id = StyledWrappedTextElement.REGISTRY_NAME, modid = PL2Constants.MODID)
