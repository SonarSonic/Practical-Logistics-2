...
public abstract class GuiAbstractEditScreen extends GuiLogistics {
	...
	public void drawGuiContainerBackgroundLayer(float partialTicks, int x, int y) {
		...
		drawTransparentRect(this.guiLeft, this.guiTop + xSize / 2 + 20, this.guiLeft + this.xSize, this.guiTop + xSize / 2 + 20 + 80, PL2Colours.layers[1].getRGB());
		drawTransparentRect(this.guiLeft + 1, this.guiTop + 1 + xSize / 2 + 20, this.guiLeft + this.xSize - 1, this.guiTop + xSize / 2 + 20 + 80 - 1, PL2Colours.layers[2].getRGB());
