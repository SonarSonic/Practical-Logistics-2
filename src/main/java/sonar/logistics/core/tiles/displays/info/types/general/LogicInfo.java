...
@ASMInfo(id = LogicInfo.id, modid = PL2Constants.MODID)
public class LogicInfo extends BaseInfo<LogicInfo> implements IProvidableInfo<LogicInfo>, INameableInfo<LogicInfo>, ISuffixable, IComparableInfo<LogicInfo> {
	...
	public String getClientIdentifier() {
		String newMethod = MasterInfoRegistry.INSTANCE.clientAdjustments.get(iden.getObject());
		if (newMethod != null) {
	...
	public Pair<String, String> updateAdjustments(boolean forceUpdate) {
		if (forceUpdate || (prefix == null || suffix == null)) {
			prefix = "";
			suffix = "";
			Pair<String, String> adjustment = MasterInfoRegistry.INSTANCE.infoAdjustments.get(iden.getObject());
			if (adjustment != null) {
