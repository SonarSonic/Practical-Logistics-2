...
import sonar.logistics.core.tiles.displays.info.types.progress.ElementProgressBar.ProgressBarDirection;
...
public class GuiEditProgressBar extends GuiAbstractEditElements {
	...
	public void actionPerformed(GuiButton button) throws IOException {
		...
		case 0:
			...
			break;
		case 1:
			element.barType = SonarHelper.incrementEnum(element.barType, ElementProgressBar.ProgressBarType.values());
			reset();
			break;
		case 2:
