...
public class GuidePageLink {
	...
	public GuidePageLink(int guidePageLink, int stringWidth, int lineNum, int index) {
	...
	public GuidePageLink setDisplayPosition(int displayPage, int displayX, int displayY) {
	...
	public boolean equals(Object obj) {
		if (obj != null && obj instanceof GuidePageLink) {
